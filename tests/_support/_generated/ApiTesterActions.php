<?php  //[STAMP] 4dbc115ddac568f3f3fcdedd5c442409
...
trait ApiTesterActions
{
     ...
     *
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Helper\Api::seeResponseJsonArrayLengthIs()
     */
    public function canSeeResponseJsonArrayLengthIs($expectedLength) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeResponseJsonArrayLengthIs', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
    ...
    public function seeResponseJsonArrayLengthIs($expectedLength) {
        return $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeResponseJsonArrayLengthIs', func_get_args()));
    }
}
